...
// import LocalCpuplayer from './components/LocalMultiplayer'
import LocalCpuplayer from './checkers'
// import LocalCpuSettings from './components/LocalCpuSettings'
      ...
      {!username ? (
        ...
        <BrowserRouter>
          <Routes>
            ...
            />
            {/* <Route path='/local-cpuplayer' element={<LocalCpuplayer sound={sound} />} /> */}
            {/* <Route path='/local-cpu-settings' element={<LocalCpuSettings sound={sound} />} /> */}
            <Route path='/local-cpuplayer' element={<LocalCpuplayer sound={sound} />} />
